...
El encabezado de control, los títulos de sección, el índice, las tablas y las firmas deben sentirse como partes de un mismo documento. Los títulos y sus números usan la misma familia sans, con texto oscuro sobre blanco y un acento teal lateral muy estrecho; no llenar toda la anchura con teal. El índice es una tabla compacta de número, sección y página: sus celdas alinean los datos sin recurrir a líneas guía decorativas. No aplicar bordes superiores gruesos a tarjetas o cuadros de firma. El espacio horizontal dentro de cada firma se distribuye en dos columnas por fila y la línea para firmar conserva su función, sin convertirse en un acento gráfico. Código, revisión y clasificación comparten una fila propia dentro del encabezado inicial; el número de página se reserva para el pie. El encabezado de continuación dice «Política», presenta el título, identidad y código, y ajusta su altura al contenido. Su casilla de logo es ancha pero no alta para que los logos apaisados se lean sin aumentar la franja; los logos cuadrados conservan su proporción. El pie identifica el departamento como área de implementación y muestra la paginación.
