...
- Memo CTA cards default to neutral colors but support custom text and background colors. Keep the illustration on the right and all CTA content on the left. Always enclose the QR in a white rounded sticker with 3mm padding, independently of the card palette. Do not recolor the QR background or remove its quiet zone.
